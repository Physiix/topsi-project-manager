export default {
	...
	"pt-br": {
		...
		"firstUseContent": `<strong>Pressione CTRL + D a qualquer momento para exibir a página de ajuda.</strong> <br /> Como esta é a primeira vez que você está usando este aplicativo, por favor, configure os próximos valores padrão a serem usados pelo aplicativo. <br/> <br/> Todas as configurações podem ser
		<strong>modificadas </strong> a qualquer momento.`,
		"firstUseSetupFolder": "Setup the default folder to store your projects.",
		"firstUseSetupColor": "Configurar a cor do aplicativo padrão",
		"aboutContent": "O Gerenciador de Projeto Topsi é um software de quadro kanban simples, construído com electron e vuejs. Suporta todas as três principais plataformas (Windows, Linux e OSX). É grátis e código aberto sob a cláusula AGPL V3.<br /><br /><br /> <strong>github: </strong> <a>https://github.com/Physiix/topsi-project-manager</a>",
		"searchLabel": "Pesquise por título, tags, projeto ...",
		"helperTitle": "Ajuda/Atalhos",
		"newMilestoneLabel": "Nome da Milestone",
		"category": "Categoria",
		"milestone": "Milestone",
		"noTagFound": "Nenhuma tag encontrada. Tags precisam ser criadas antes de serem usadas.",
		...
		"layoutAndOptions": "Layout & Opções",
		"project": "Projeto",
		"title": "Titulo",
		"tags": "Tags",
		"backToProjects": "voltar para os projetos",
		"searchInNotes": "pesquisar em notas (CTRL + F)",
		"addNewNote": "Adicionar nova Nota",
		"editProject": "Editar Projeto",
		"milestones": "Milestones",
		"noTagsCreated": "Nenhuma tag criada ainda. ",
		"confirmDeleteMessage": "Tem certeza de que deseja excluir este projeto?",
		"export": "Exportar",
		"general": "Geral",
		"about": "Sobre",

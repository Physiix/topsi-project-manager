<template>
    <div id="titlebar">
        <v-toolbar app :class="color" height="30" class="elevation-0 px-0" dark>
            ...
            <v-btn flat class="titlebar-btn mx-0" @click="maximise">
                <svg v-if="!maximized" width="9" height="9" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11 0v11H0V0h11zM9.899 1.101H1.1V9.9H9.9V1.1z" fill="#fff"></path>
                </svg>
                <svg v-else width="9" height="9" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11 8.798H8.798V11H0V2.202h2.202V0H11v8.798zm-3.298-5.5h-6.6v6.6h6.6v-6.6zM9.9 1.1H3.298v1.101h5.5v5.5h1.1v-6.6z" fill="#fff"></path>
                </svg>
            </v-btn>
            <v-btn flat class="titlebar-btn mx-0 close-btn" @click="close">
                <svg width="9" height="9" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.279 5.5L11 10.221l-.779.779L5.5 6.279.779 11 0 10.221 4.721 5.5 0 .779.779 0 5.5 4.721 10.221 0 11 .779 6.279 5.5z" fill="#fff"></path>
                </svg>
            </v-btn>
        </v-toolbar>
    </div>
...
export default {
    ...
    computed: {
        color() {
            ...
            const darkenToolbar = this.$store.getters.darkenToolbar;
